...
function AboutUs() {
  return (
    <div className={`flex flex-col mt-[20%] mb-[10%] lg:mb-[5%] xl:mt-[30%] justify-between h-[650px] md:h-[700px] lg:h-[600px] xl:h-[100vh] lg:flex-row xl:pr-8 landscape:h-[800px] landscape:mb-[100px] `}>
