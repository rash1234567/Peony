...
function AboutUs() {
  return (
    <div className={`flex flex-col mt-[20%] mb-[10%] lg:mb-[5%] xl:mt-[20%] xl:mb-[10vh] justify-between h-[650px] md:h-[700px] bg-green-700 lg:h-[600px] xl:h-[100vh] lg:flex-row xl:pr-8 ${indexStyles.AboutUsDiv}`}>
