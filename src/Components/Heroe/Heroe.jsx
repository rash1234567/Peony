          ...
          <div className={heroStyles.overlay}>
            <div className={` md:[w-70%] xl:w-[60%] px-4 h-[80%] lg:h-[66%] ml-[6%] flex flex-col justify-around ${heroStyles.textCont}`}>
              ...
              <div className={`w-[80%] lg:w-[60%]  flex justify-between ${heroStyles.btns}`}>
                ...
                <button className={`text-white text-[12px] md:text-[16px] 3xl:text-[28px] 4xl:text-[32px] font-[700] font-openSans ${heroStyles.wvBtn} hover:bg-[#004A00] w-[100px] md:w-[180px] `}><i class="fa-solid fa-play mr-1 md:mr-3 "></i> Watch Video</button>
              </div>
            </div>
          </div>
      </div>
