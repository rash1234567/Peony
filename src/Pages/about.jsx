...
function About() {
  return (
    <div>
        ...
        <AboutUs/>
        {/* connect */}
        <div className='bg-[#C4F4D7] h-[30vh] lg:h-[20vh] xl:h-[30vh] relative flex items-center '>
            <div className='lg:ml-[33%] h-[50%] w-full lg:w-[70%] xl:w-[50%] flex flex-col lg:flex-row items-center justify-around lg:justify-start text-center lg:text-start'>
                 ...
                 <button className='bg-[#04E761] ml-[2%] w-[20%] text-white py-2 text-[12px] md:text-[16px] font-openSans rounded-[5px] z-10'>Contact Us</button>
            </div>
